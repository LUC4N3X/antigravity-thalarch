...
- OpenAI Codex — Agent Skills, `AGENTS.md`, native read-only custom agents and Codex lifecycle hooks.
- Anthropic Claude Code — skills, `CLAUDE.md`, native read-only custom subagents and Claude lifecycle hooks.
